...
bot.on("message", async message => {
	...
	else if(getGame(change_alias(message.content)) !=false&&message.content.toLowerCase().indexOf("google")==-1&&message.author.id!="574602677929902080"&&message.channel.id =="533170013129932801"&&message.member.roles.cache.some(r => r.name === "Mod")==false){
